...
class StaffVendorManagementScreen extends StatefulWidget {
  ...
  @override
  State<StaffVendorManagementScreen> createState() =>
      _StaffVendorManagementScreenState();
}

class _StaffVendorManagementScreenState
    extends State<StaffVendorManagementScreen> {
  ...
  void _navigateToStaffDetails(StaffMember firestoreStaff) {
    ...
    final oldModelStaff = models.StaffMember(
      ...
      salary: firestoreStaff.salary != null
          ? '₹${firestoreStaff.salary!.toStringAsFixed(0)}/month'
          : 'Not Set',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          const StandardHeader(title: 'Staff Management', showBackButton: true),
...
class StaffListItem extends StatelessWidget {
  ...
  const StaffListItem({super.key, required this.staffMember, this.onTap});
            ...
            Column(
              children: [
                ...
                if (staffMember.getCheckInTimeDisplay() != null) ...[
                  ...
                  _buildDetailRow(
                    'Checked in:',
                    staffMember.getCheckInTimeDisplay()!,
                  ),
                ],
              ],
            ),
