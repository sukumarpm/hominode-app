...
class ParkingManagementVisitorScreen extends StatefulWidget {
  ...
  @override
  State<ParkingManagementVisitorScreen> createState() =>
      _ParkingManagementVisitorScreenState();
}

class _ParkingManagementVisitorScreenState
    extends State<ParkingManagementVisitorScreen> {
              ...
              children: [
                ...
                OutlinedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Take Action - Coming soon'),
                      ),
                    );
                  },
