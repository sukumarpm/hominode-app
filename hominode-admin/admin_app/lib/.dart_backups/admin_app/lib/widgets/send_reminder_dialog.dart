        ...
        children: [
          ...
          Expanded(
            child: ElevatedButton(
              onPressed: _isLoading || (!_sendViaPush && !_sendViaEmail && !_sendViaSMS) 
                  ? null 
                  : _handleSendReminder,
...
void showSendReminderDialog(BuildContext context, String announcementTitle, VoidCallback onConfirm) {
  showDialog(
    context: context,
