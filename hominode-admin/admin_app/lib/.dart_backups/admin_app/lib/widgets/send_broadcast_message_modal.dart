...
class SendBroadcastMessageModal extends StatefulWidget {
  ...
  @override
  State<SendBroadcastMessageModal> createState() => _SendBroadcastMessageModalState();
}
                        ...
                        : Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<Map<String, dynamic>>(
                                ...
                                items: recipientOptions.map((Map<String, dynamic> option) {
                                  return DropdownMenuItem<Map<String, dynamic>>(
                                    value: option,
                                    child: _buildDropdownItem(option['label'], option['type']),
                                  );
                                }).toList(),
