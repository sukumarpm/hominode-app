...
class UnauthorizedVehicleActionModal extends StatefulWidget {
  ...
  @override
  State<UnauthorizedVehicleActionModal> createState() => _UnauthorizedVehicleActionModalState();
}

class _UnauthorizedVehicleActionModalState extends State<UnauthorizedVehicleActionModal> {
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w600,
                        color: isSelected ? action.color : const Color(0xFF111827),
                      ),
                    ),
