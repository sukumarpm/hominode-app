...
class AddResidentVehicleModal extends StatefulWidget {
  ...
  @override
  State<AddResidentVehicleModal> createState() => _AddResidentVehicleModalState();
}
...
class _AddResidentVehicleModalState extends State<AddResidentVehicleModal> {
  ...
  final List<ParkingSlotOption> _availableParkingSlots = [
    ParkingSlotOption(id: 'A1', slotNumber: 'A-1', type: 'Car', isAvailable: true),
    ParkingSlotOption(id: 'A2', slotNumber: 'A-2', type: 'Car', isAvailable: true),
    ParkingSlotOption(id: 'A3', slotNumber: 'A-3', type: 'Car', isAvailable: true),
    ParkingSlotOption(id: 'B1', slotNumber: 'B-1', type: 'Bike', isAvailable: true),
    ParkingSlotOption(id: 'B2', slotNumber: 'B-2', type: 'Bike', isAvailable: true),
    ParkingSlotOption(id: 'B3', slotNumber: 'B-3', type: 'Bike', isAvailable: true),
    ParkingSlotOption(id: 'C1', slotNumber: 'C-1', type: 'Car', isAvailable: true),
    ParkingSlotOption(id: 'C2', slotNumber: 'C-2', type: 'Car', isAvailable: true),
  ];
  ...
  Widget _buildParkingSlotDropdown() {
    ...
    List<ParkingSlotOption> filteredSlots = _availableParkingSlots.where((slot) {
      ...
      if ((_selectedVehicleType == 'Four Wheeler' || 
           ...
           _selectedVehicleType == 'Guest Vehicle') && slot.type == 'Car') {
        return true;
      }
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
            ...
            return DropdownMenuItem<String>(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text('${slot.slotNumber} (${slot.type})'),
                  ),
                  if (slot.isAvailable)
                    Container(
          ...
          onChanged: _selectedVehicleType == null ? null : (String? newValue) {
            setState(() {
