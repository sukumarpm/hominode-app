  ...
  static Future<void> show(
    ...
    return showGeneralDialog(
      ...
      pageBuilder: (context, animation, secondaryAnimation) {
        return EditResidentDetailsDialog(
          resident: resident,
          onSaved: onSaved,
        );
      },
...
class _EditResidentDetailsDialogState extends State<EditResidentDetailsDialog> {
  ...
  void initState() {
    ...
    _unitNumberController =
        TextEditingController(text: widget.resident.unitNumber);
    _phoneController = TextEditingController(text: widget.resident.phoneNumber);
    _familyMembersController =
        TextEditingController(text: widget.resident.familyMembers.toString());
    _vehiclesController =
        TextEditingController(text: widget.resident.vehicles.toString());
  }
