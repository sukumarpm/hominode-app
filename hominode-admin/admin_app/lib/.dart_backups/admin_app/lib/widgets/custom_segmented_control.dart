...
class CustomSegmentedControl extends StatefulWidget {
  ...
  const CustomSegmentedControl({
    ...
    this.height = 44.0,
  }) : assert(tabs.length >= 2 && tabs.length <= 4, 'Tabs must be between 2-4 items');
    ...
    return Container(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final segmentWidth = (constraints.maxWidth - (4 * 2)) / widget.tabs.length;
              ...
              AnimatedBuilder(
                ...
                builder: (context, child) {
                  return AnimatedAlign(
                    ...
                    curve: Curves.easeOutCubic,
                    alignment: Alignment(
                      -1.0 + (2.0 * widget.selectedIndex / (widget.tabs.length - 1)),
                      0.0,
                    ),
                    child: Container(
                      width: segmentWidth,
...
class _IconSegmentedControlState extends State<IconSegmentedControl> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final segmentWidth = (constraints.maxWidth - 8) / widget.segments.length;
          ...
          return Stack(
            children: [
              ...
              AnimatedAlign(
                ...
                curve: Curves.easeOutCubic,
                alignment: Alignment(
                  -1.0 + (2.0 * widget.selectedIndex / (widget.segments.length - 1)),
                  0.0,
                ),
                child: Container(
                  width: segmentWidth,
