...
class _ParcelDeliveryTrackingScreenState
  ...
  List<ParcelEntry> get _filteredPendingParcels {
    ...
    return _pendingParcels.where((parcel) {
      return parcel.residentName.toLowerCase().contains(_searchQuery.toLowerCase()) ||
  ...
  Widget _buildSummaryMetrics() {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
            child: _buildMetricCard('8', 'Today', const Color(0xFF2563EB)),
          ),
          ...
          const SizedBox(width: 12),
          Expanded(
            child: _buildMetricCard('${_pendingParcels.length}', 'Pending', const Color(0xFFD97706)),
          ),
          const SizedBox(width: 12),
          Expanded(
    ...
    return Column(
      ...
      children: [
        ...
        if (filteredParcels.isEmpty)
          ...
          ...filteredParcels.map((parcel) => Padding(
