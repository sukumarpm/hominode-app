...
class _CommunicationCenterScreenState extends State<CommunicationCenterScreen> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildFilterOption('All Messages', 'all', Icons.all_inclusive),
                  _buildFilterOption('Push Notifications', 'push', Icons.notifications),
  ...
  CommunicationStats _getCommunicationStats() {
    ...
    final totalDelivered = broadcastHistory.fold<int>(0, (sum, msg) => sum + msg.deliveredCount);
    final totalSent = broadcastHistory.fold<int>(0, (sum, msg) => sum + msg.recipientCount);
    final deliveryRate = totalSent > 0 ? (totalDelivered / totalSent * 100) : 0.0;

    final totalRead = broadcastHistory.fold<int>(0, (sum, msg) => sum + msg.readCount);
                  ...
                  delegate: SliverChildListDelegate([
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: _buildTabButton('Messages', 0),
                          ),
                          Expanded(
                            child: _buildTabButton('Pinned Posts', 1),
                          ),
                          Expanded(
        ...
        Center(
          child: Padding(
            ...
            child: Column(
              children: [
                Icon(
                  _searchController.text.isNotEmpty ? Icons.search_off : Icons.message_outlined,
                  size: 64,
                  color: Colors.grey[300],
                ),
                const SizedBox(height: 16),
                Text(
                  _searchController.text.isNotEmpty ? 'No messages found' : 'No messages yet',
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w600,
                    color: Colors.grey[600],
    ...
    return [
      ...
      StreamBuilder<List<PinnedPostModel>>(
        ...
        builder: (context, snapshot) {
          ...
          return Column(
            children: pinnedPosts.map((post) => Column(
              children: [
        ...
        child: OutlinedButton.icon(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => BroadcastHistoryScreen(),
              ),
            );
          },
  ...
  Widget _buildPinnedPostCard(String postId, String title, String description, String date, {VoidCallback? onDelete, VoidCallback? onEdit}) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Are you sure you want to delete this pinned post? This action cannot be undone.'),
          actions: [
            TextButton(
  ...
  static List<BroadcastMessage> getSampleBroadcasts() {
    return [
      BroadcastMessage(
        ...
        content: 'Your maintenance bill for January 2025 has been generated. Please check your account for details.',
        type: 'Push',
        recipientCount: 248,
        deliveredCount: 245,
        readCount: 198,
      ...
      BroadcastMessage(
        ...
        content: 'A visitor has been approved for your flat. Please be available to receive them.',
        type: 'Push',
        recipientCount: 1,
        deliveredCount: 1,
        readCount: 1,
      ...
      BroadcastMessage(
        ...
        content: 'You are invited to the New Year celebration on January 1st at the community hall.',
        type: 'Email',
        recipientCount: 248,
        deliveredCount: 240,
        readCount: 180,
      ...
      BroadcastMessage(
        ...
        content: 'New security protocols have been implemented. Please carry your ID cards at all times.',
        type: 'Push',
        recipientCount: 248,
        deliveredCount: 242,
        readCount: 195,
