...
class ApartmentImagesManagementScreen extends StatefulWidget {
  ...
  @override
  State<ApartmentImagesManagementScreen> createState() => _ApartmentImagesManagementScreenState();
}
...
class _ApartmentImagesManagementScreenState extends State<ApartmentImagesManagementScreen> {
  ...
  void _showUploadModal() {
    if (_buildingId == null || _buildingId!.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Building ID not found. Please ensure your profile is set up correctly.'),
        ...
        if (images.isEmpty) {
          return Padding(
            ...
            child: Center(
              child: Column(
                children: [
                  Icon(Icons.image_not_supported, size: 56, color: Colors.grey[400]),
