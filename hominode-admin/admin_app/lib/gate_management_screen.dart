  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.add, color: Color(0xFF0E4778)),
            onPressed: () {
  ...
  Widget _buildStatsCards() {
    return FutureBuilder<GateStats>(
      ...
      builder: (context, snapshot) {
        ...
        final stats =
            snapshot.data ??
            GateStats(total: 0, active: 0, inactive: 0, maintenance: 0);
    ...
    if (confirmed == true) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              success ? 'Place deleted successfully' : 'Failed to delete place',
            ),
